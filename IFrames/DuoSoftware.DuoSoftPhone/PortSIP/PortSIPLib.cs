...
namespace PortSIP
{
    ...
    internal unsafe class PortSIPLib
    {
        ...
        */
        ...
        public Int32 initialize(TransportType transportType,
                                          PortsipLogLevel logLevel,
                                          String logFilePath,
                                          Int32 maxCallLines,
                                          String sipAgent,
                                          ...
                                          Boolean useVirtualVideoDevice)
        {
            ...
            {
                return PortSipErrors.ECoreSdkObjectNull;
            }
        ...
        public Int32 unRegisterServer()
        {
            ...
            {
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger4, "unRegisterServer", exception, Logger.LogLevel.Error);
                return 0;
            }
        }
        ...
        public Int32 addAudioCodec(AudiocodecType codecType)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 addVideoCodec(VideocodecType codecType)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 setAudioCodecPayloadType(AudiocodecType codecType, Int32 payloadType)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 setVideoCodecPayloadType(VideocodecType codecType, Int32 payloadType)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 setAudioCodecParameter(AudiocodecType codecType, String parameter)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 setVideoCodecParameter(VideocodecType codecType, String parameter)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 setSrtpPolicy(SrtpPolicy srtpPolicy)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 enableSessionTimer(Int32 timerSeconds, SessionRefreshMode refreshMode)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 setVideoResolution(VideoResolution resolution)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 call(String callee, Boolean sendSdp, Boolean videoCall)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.InvalidSessionId;
            }
        ...
        public Int32 sendDtmf(Int32 sessionId, DtmfMethod dtmfMethod, int code, int dtmfDuration, bool playDtmfTone)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 enableAudioStreamCallback(Int32 callbackObject, Int32 sessionId, Boolean enable, AudiostreamCallbackMode callbackMode)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 enableVideoStreamCallback(Int32 callbackObject, Int32 sessionId, VideostreamCallbackMode callbackMode)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 startRecord(Int32 sessionId,
                                ...
                                AudioRecordingFileformat audioFileFormat,
                                RecordMode audioRecordMode,
                                VideocodecType videoFileCodecType,
                                RecordMode videoRecordMode)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
        ...
        public Int32 createConference(IntPtr conferenceVideoWindow, VideoResolution videoResolution, Boolean displayLocalVideoInConference)
        {
            if (_LibSDK == IntPtr.Zero)
            {
                return PortSipErrors.ECoreSdkObjectNull;
