...
namespace PortSIP
{
    public class PortSipErrors
    {
        public static readonly int InvalidSessionId = -1;
        ...
        public static readonly int ECoreFixPayloadCannotChange = -60073;   //  It's fixed payload type does not allows changed.
        ...
        public static readonly int EAudioCannotSetDeviceIdDuringCall = -70019;
        ...
        public static readonly int EVideoCannotSetDeviceIdDuringCall = -80010;
