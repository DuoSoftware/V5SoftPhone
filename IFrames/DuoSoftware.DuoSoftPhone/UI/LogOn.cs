    ...
    public partial class LogOn : Form
    {
        ...
        private string GetLocalIpAddress()
        {
            try
            {
                ...
                var myIp = (from ipAddress in Dns.GetHostEntry(myHost).AddressList
                ...
                if (IsValidIp(myIp)) return myIp;
                var myIp1 = Dns.GetHostAddresses(myHost);
        ...
        private static bool IsValidIp(params object[] list)
        {
            try
            {
                ...
                valid = addr != string.Empty && check.IsMatch(addr, 0);
                //return the results
                return valid;
            }
            catch (Exception exception)
        ...
        private void Login_Load(object sender, EventArgs e)
        {
            ...
            var mutex = new Mutex(true, "DuoSoftPhone", out ok);
