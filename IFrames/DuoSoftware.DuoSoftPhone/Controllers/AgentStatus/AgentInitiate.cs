...
namespace DuoSoftware.DuoSoftPhone.Controllers.AgentStatus
{
    ...
    ///
    /// </summary>
    internal class AgentInitiate : AgentEvent
    {
        ///  <summary>
        /// 
        ///  </summary>
        ...
        public override void OnResetStatus(Agent agent)
        {
            ...
            //catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentInitiate", exception, Logger.LogLevel.Error); }
            Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentInitiate", new NotImplementedException("Invalid Agent Status."), Logger.LogLevel.Error);
        }
        ...
        {
            //try { throw new NotImplementedException("Invalid Agent Status."); }
            Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentInitiate", new NotImplementedException("Invalid Agent Status."), Logger.LogLevel.Error);//catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentInitiate", exception, Logger.LogLevel.Error); }
