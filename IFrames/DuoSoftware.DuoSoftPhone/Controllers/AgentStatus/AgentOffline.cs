...
namespace DuoSoftware.DuoSoftPhone.Controllers.AgentStatus
{
    ...
    ///
    /// </summary>
    public class AgentOffline : AgentEvent
    {
        ///  <summary>
        /// 
        ///  </summary>
        ...
        public override void OnResetStatus(Agent agent)
        {
            ...
            Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentOffline", new NotImplementedException("Invalid Agent Status."), Logger.LogLevel.Error);
        }
