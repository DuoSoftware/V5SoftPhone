...
namespace DuoSoftware.DuoSoftPhone.Controllers.AgentStatus
{
    ...
    ///
    /// </summary>
    internal class AgentBusy : AgentEvent
    {
        ///  <summary>
        /// 
        ///  </summary>
        ...
        public override void OnMakeCall(Agent agent)
        {
            try
            {
                if (agent != null) agent.ResourceStatusChangeBusy();
            }
            catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentBusy", exception, Logger.LogLevel.Error); }
        }
        ...
        public override void OnFailMakeCall(Agent agent)
        {
            try
            {
                if (agent != null) agent.AgentCurrentState = new AgentAcw();
            }
            catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentBusy", exception, Logger.LogLevel.Error); }
        }
        ...
        public override void OnEndCall(Agent agent, bool isCallAnswerd)
        {
            try
            {
                if (agent != null) agent.AgentCurrentState = isCallAnswerd ? (AgentEvent)new AgentAcw() : new AgentIdle();
            }
            catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentBusy", exception, Logger.LogLevel.Error); }
        }
        ...
        {
            try { if (agent != null) agent.SendStatusChangeRequestBreak(breakReason); }
            catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentBusy", exception, Logger.LogLevel.Error); }
        }
        ...
        {
            try { if (agent != null) agent.CancelBreakRequest(); }
            catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger2, "AgentBusy", exception, Logger.LogLevel.Error); }
        }
