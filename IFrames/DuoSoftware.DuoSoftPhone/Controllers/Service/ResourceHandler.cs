...
{
    public class SoftPhoneResourceHandler : ISoftPhoneResourceHandler
    {
        private readonly ISoftPhoneResourceHandler handler;
        ...
        public SoftPhoneResourceHandler(string securityToken, int tenantId, int companyId)
        {
        ...
        {
            handler.SendStatusChangeRequestIdel(auth, callSessionId, isCallAnswer, transferCall);
        }
    }
}