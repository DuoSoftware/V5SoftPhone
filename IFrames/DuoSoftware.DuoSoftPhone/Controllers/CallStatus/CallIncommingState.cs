...
namespace DuoSoftware.DuoSoftPhone.Controllers.CallStatus
{
    ...
    public class CallIncommingState : CallState
    {
        ...
        {
            Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "CallIncommingState", new NotImplementedException("Invalid Call Status."), Logger.LogLevel.Error);
        }
        ...
        public override void OnDisconnected(Call call)
        {
            ...
            catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "CallIncommingState", exception, Logger.LogLevel.Error);
                throw;
            }
        }
