...
namespace DuoSoftware.DuoSoftPhone.Controllers.CallStatus
{
    ...
    public class CallIdleState : CallState
    {
        ...
        {
            Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "CallIdleState", new NotImplementedException("Invalid Call Status."), Logger.LogLevel.Error);
        }
        ...
        public override void OnDisconnected(Call call)
        {
            ...
            catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "CallIdleState", exception, Logger.LogLevel.Error);
                throw;
            }
        }
        ...
        {
            try {
                if (call != null) call.CallCurrentState = new CallTryingState();
            }
            catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "CallIdleState", exception, Logger.LogLevel.Error);
                throw;
            }
        ...
        {
            if (call != null) call.CallCurrentState = new CallRingingState();
        }
        ...
        {
            if (call != null) call.CallCurrentState = new CallIncommingState();
        }
