...
namespace DuoSoftware.DuoSoftPhone.Controllers.CallStatus
{
    ...
    public class CallTryingState : CallState
    {
        ...
        {
            Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "CallTryingState", new NotImplementedException("Invalid Call Status."), Logger.LogLevel.Error);
        }
        ...
        public override void OnDisconnected(Call call)
        {
            ...
            catch (Exception exception) { Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "CallTryingState", exception, Logger.LogLevel.Error);
                throw;
            }
        }
