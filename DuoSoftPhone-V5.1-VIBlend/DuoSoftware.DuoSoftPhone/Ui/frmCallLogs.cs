...
namespace DuoSoftware.DuoSoftPhone.Ui
{
    public partial class frmCallLogs : Form
    {
        ...
        public void AddIncommingToCallLogs(string no, DateTime time, double durations)
        {
            try
            {
        ...
        public void AddOutgoingCallToCallLogs(string no, DateTime time, double durations)
        {
            try
            {
                var appearance = new Infragistics.Win.Appearance
        ...
        public void AddMissCallToCallLogs(string no, DateTime time, double durations)
        {
            try
            {
                var appearance = new Infragistics.Win.Appearance
