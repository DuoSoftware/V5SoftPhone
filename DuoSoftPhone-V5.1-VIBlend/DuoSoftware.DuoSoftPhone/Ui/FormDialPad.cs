...
namespace DuoSoftware.DuoSoftPhone.Ui
{
    public partial class FormDialPad : Form, SIPCallbackEvents, IUiState
    {
        ...
        private ResourceCheckerHandler resourceMonitoringHandler;
        ...
        private void btnCloseAgentList_Click(object sender, System.EventArgs e)
        {
        ...
        private void FormDialPad_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                #region resourceMonitoringHandler

                resourceMonitoringHandler = new ResourceCheckerHandler(ref _agent,ref call);
                resourceMonitoringHandler.OnResourceStatusMisMatch += () =>
                {
                    try
                    {
        ...
        private void AutoAnswer_CheckedChanged(object sender, System.EventArgs e)
        {
            try
            {
                if (AutoAnswer.Checked)
                {
                    AutoAnswer.BackColor = Color.Maroon;
                }
                else
                {
                    AutoAnswer.BackColor = Color.Black;
                }
            }
            catch (Exception exception)
            {
        ...
        public void InAgentIdleState(AgentEvent agentPvState)
        {
            try
            {
                this.Invoke(((MethodInvoker)(() =>
                {
                    ...
                    {
                        PhoneStatus.Image = Properties.Resources.online;
                        new Thread(() => resourceMonitoringHandler.StartStatusMap()).Start();
                    }
