    ...
    public class AsynchronousSocketListener
    {
        ...
        private  void SendCallback(IAsyncResult ar)
        {
            try
            {
                ...
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, string.Format("SendCallback-Sent {0} bytes to client.", bytesSent), Logger.LogLevel.Info);
            ...
            {
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "SendCallback", exception, Logger.LogLevel.Error);
            }
        }
        ...
        private void MessageRevice(string msg)
        {
            try
            {
                ...
                */
                ...
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "MessageRevice : "+msg, Logger.LogLevel.Info);
            ...
            {
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "MessageRevice", exception, Logger.LogLevel.Error);
            }
        }
            ...
            try
            {
                ...
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "Waiting for a connection...", Logger.LogLevel.Info);
                ...
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "continue...", Logger.LogLevel.Info);

            }
            catch (Exception exception)
            {
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "StartListening", exception, Logger.LogLevel.Error);
            }
        }
        ...
        public  void ReadCallback(IAsyncResult ar)
        {
            try
            {
                ...
                if (bytesRead > 0)
                {
                    ...
                    if (content.IndexOf("<EOF>") > -1)
                    {
                        ...
                        Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, string.Format("Read {0} bytes from socket. \n Data : {1}", content.Length, content), Logger.LogLevel.Info);
            ...
            {
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "ReadCallback", exception, Logger.LogLevel.Error);
            }
        }
