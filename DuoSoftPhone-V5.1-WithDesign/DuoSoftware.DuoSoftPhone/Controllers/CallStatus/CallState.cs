...
namespace DuoSoftware.DuoSoftPhone.Controllers.CallStatus
{
    public abstract class CallState
    {
        ...
        public abstract void OnEndLinkLine(ref Call call,PortSIPLib sipHandler);
        public abstract void OnMakeCall(ref Call call,PortSIPLib sipHandler,string number);
        ...
        public abstract void OnCallConference(ref Call call, PortSIPLib sipHandler);
        public abstract void OnCallConferenceFail(ref Call call);
        public abstract void OnSetStatus(ref Call call);
        public abstract void OnSendDTMF(ref Call call, PortSIPLib sipHandler,int val);
