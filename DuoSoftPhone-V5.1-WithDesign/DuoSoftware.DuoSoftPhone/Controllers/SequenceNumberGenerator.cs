...
namespace DuoSoftware.DuoSoftPhone.Controllers
{
    public sealed class SequenceNumberGenerator
    {
        ...
        private SequenceNumberGenerator()
        {
            ...
            {
                Logger.Instance.LogMessage(Logger.LoggerFiles.DuoDefault, "SequenceNumberGenerator", exception, Logger.LogLevel.Error);
                throw;
            }
        }
        ...
        private void GenerateNos()
        {
            ...
            {
               Logger.Instance.LogMessage(Logger.LoggerFiles.DuoDefault, "GenerateNos",exception,Logger.LogLevel.Error);
            }
        }
